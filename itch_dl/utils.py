...
def should_skip_item_by_glob(kind: Literal["File"] | Literal["URL"], item: str, glob: str | None) -> bool:
...
def should_skip_item_by_regex(kind: Literal["File"] | Literal["URL"], item: str, regex: str | None) -> bool:
